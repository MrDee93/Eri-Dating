...
extension UIImageView {
    ...
    // FIXME: Finish enabling to save filename to imageview to make deleting photos easier
    func setFilenameUsingUrl(urlString: String, userID:String) {
        
        let firstIndex = urlString.index(after: urlString.index(userID))
